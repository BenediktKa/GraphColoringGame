...
public class Graph {
	...
	public void positionNodes() {
		...
		for (int i = 0; i < vertices; i++) {
			GraphNode node = new GraphNode(handler, (int)(centerX + radiusCircle * Math.cos(Math.PI * i * divisions)), (int)(centerY + radiusCircle * Math.sin(Math.PI * i * divisions)), ID.GraphNode, i, adjacencyMatrix);
